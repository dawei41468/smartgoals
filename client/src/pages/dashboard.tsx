        ...
        <div className="space-y-8">
          ...
          <div className="bg-gradient-to-r from-primary to-primary/80 rounded-xl p-8 text-white">
            <div className="max-w-2xl">
              <h1 className="text-3xl font-bold mb-4">Transform Your Goals into Actionable Plans</h1>
              ...
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-bold" data-testid="stat-active-goals">
            ...
            {goalsLoading ? (
              ...
              <div className="p-6">
                <div className="text-center py-8">
                  ...
                  <Button onClick={handleStartGoalCreation} data-testid="button-create-first-goal">
                    <Plus className="mr-2 h-4 w-4" />
            ...
            <div className="p-6">
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-muted-foreground">Welcome to SMART Goals! Create your first goal to see activity here.</span>
